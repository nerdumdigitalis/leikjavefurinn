...
namespace Leikjavefur.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Disassociate(string provider, string providerUserId)
        {
            ...
            // Only disassociate the account if the currently logged in UserProfile is the owner
            if (ownerAccount == User.Identity.Name)
            {
                // Use a transaction to prevent the UserProfile from deleting their last login credential
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            {
                // UserProfile does not have a local password so remove any validation errors caused by a missing
                // OldPassword field
        ...
        private static string ErrorCodeToString(MembershipCreateStatus createStatus)
        {
            ...
            switch (createStatus)
            {
                case MembershipCreateStatus.DuplicateUserName:
                    return "UserProfile name already exists. Please enter a different UserProfile name.";

                case MembershipCreateStatus.DuplicateEmail:
                    return "A UserProfile name for that e-mail address already exists. Please enter a different e-mail address.";
                ...
                case MembershipCreateStatus.InvalidUserName:
                    return "The UserProfile name provided is invalid. Please check the value and try again.";

                case MembershipCreateStatus.ProviderError:
                    return "The authentication provider returned an error. Please verify your entry and try again. If the problem persists, please contact your system administrator.";

                case MembershipCreateStatus.UserRejected:
                    return "The UserProfile creation request has been canceled. Please verify your entry and try again. If the problem persists, please contact your system administrator.";
